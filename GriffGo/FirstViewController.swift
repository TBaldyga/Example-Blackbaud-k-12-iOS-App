...
class FirstViewController: UIViewController {
    ...
    func picLoader() {
        ...
        Alamofire.request("https://\(BlackbaudPhotoURL)\(photo)").responseImage { response in
    ...
    func sportsGet() {
            if masterToken != "" {
                //Student XML
                Alamofire.request("https://pomfretschool.myschoolapp.com/api/list/\(SportsListID)/", parameters: ["format": "xml", "t": masterToken]).responseData { response in
